...
Route::get('c', function () {
    $logo = "<svg class=\"h-24 w-auto text-gray-800 dark:text-gray-50 fill-current\" viewBox=\"0 0 338 370\" xmlns=\"http://www.w3.org/2000/svg\">
...
Route::get('python', function () {
    $logo = "<svg class=\"h-24 w-auto text-gray-800 dark:text-gray-50 fill-current\" viewBox=\"0 0 1034 1037\" xmlns=\"http://www.w3.org/2000/svg\">
